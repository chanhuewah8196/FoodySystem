...
<script>  
    ...
    function drawChart() {  
        var data = google.visualization.arrayToDataTable([['location', 'place'],  
        <?php  
            while($row = mysqli_fetch_array($result3)) {  
                echo "['".$row["location"]."', ".$row["place"]."],";  
            }  
        ?>  
        ]);  
        var option = {   
            title: 'TOTAL NUMBER OF USERS ACCORDING TO THE LOCATION',
            pieHole: 0.4,
...
<body>
    ...
    <div class="graph">
        ...
        <br>
        <div class="piechart" id="doughnut"></div>
        <br>
